...
| 4 | Directivas Arquitectónicas | ✅ | ADR-0004 declara herencia íntegra de `unimar_arch` sin overrides |
| 5 | Baseline Agnóstica (stack agnóstico) | ✅ | `stack-tecnologico-autorizado-tms.es.md:3` referencia explícita a `unimar_arch`; formalizado en ADR-0001 |
| 6 | ADR — Topología Inicial (equiv. ADR-0047) | ✅ | ADR-0005 creado 2026-06-30 — Monolito Modular en VPS, PM2+Nginx+PostgreSQL nativo |
...
> **Listo:** Historias de Usuario (✅), Backlog Ágil (✅), cobertura 18/18, Directivas Arquitectónicas (✅), Baseline Agnóstica (✅), Topología (ADR-0005 ✅), Roadmap (✅), **alcance de diseño suficiente** (§5/§6/§7/§8 del PRD completos).
> **Sigue pendiente (no bloquea diseño):** aprobación formal del PRD (CA 0/19) y datos `{X}/{Y}/{Z}`.
